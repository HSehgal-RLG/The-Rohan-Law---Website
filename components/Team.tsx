...
const team = [
  {
    ...
    bio: "Brian has been practicing law in the Capital Region for over thirty-five (35) years. The principal practice areas of his firm are Residential & Commercial Real Estate (Representation of Buyers, Sellers and Lenders) & Title Services, Estate Planning & Administration and Business/Corporate Representation. Brian also has extensive prior work experience handling civil/commercial litigation and personal/business bankruptcy matters — the result is that he brings an extremely unique skill set to each and every transaction he handles. Brian prides himself on being extremely professional and courteous in all of his dealings, treating each and every client file as if it is the most important file on his desk at that moment. A more competent, focused, hard working, and — most importantly from a client's perspective — responsive legal advisor you will not find.",
    fullBio: {
      paragraphs: [
  ...
  return (
    <section id="team" className="bg-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        <FadeUp delay={0.1}>
          <Card
            onClick={() => setSelected(brian)}
            className="border border-gray-100 shadow-none hover:shadow-md transition-shadow duration-200 rounded-lg overflow-hidden p-0 cursor-pointer mb-8"
          >
            <div className="grid grid-cols-1 md:grid-cols-[280px_1fr]">
              ...
              <CardContent className="p-6 md:p-10 flex flex-col justify-between gap-6">
                <div>
                  <h3 className="font-serif text-navy text-2xl font-semibold leading-snug">
                    {brian.name}
                  </h3>
                  ...
                  <Separator className="my-4 bg-gray-100" />
                  <p className="text-navy/60 text-sm font-sans leading-relaxed">
                    {brian.bio}
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                  ...
                  <span className="inline-flex items-center gap-1 text-maroon text-[0.65rem] uppercase tracking-widest font-sans">
